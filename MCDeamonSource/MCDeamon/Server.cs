...
namespace MCDeamon
{
    public class Server
    {
        ...
        public static string name = "[MCDeamon] Default";
        public static string motd = "Welcome! +Hax";
        public static byte players = 25;
        public static byte maps = 25;
        ...
        public static string DeamonState = "Deamon";
        ...
        public static string ircNick = "MCDeamon_Minecraft_Bot";
        ...
        public static string MySQLDatabaseName = "MCDeamonDB";
