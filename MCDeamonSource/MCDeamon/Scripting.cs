/*
	Copyright 2010 MCDeamon Team - Written by Valek
    ...
    static class Scripting
    {
        ...
        public static void CreateNew(string CmdName)
        {
            ...
            sw.Write(
                ...
                Environment.NewLine +
                "\tUse this as a basis for custom commands implemented via the MCDeamon scripting framework." + Environment.NewLine +
                ...
                "// As a note, MCDeamon is designed for .NET 3.5." + Environment.NewLine +
                "using System;" + Environment.NewLine +
                Environment.NewLine +
                "namespace MCDeamon" + Environment.NewLine +
                "{" + Environment.NewLine +
        ...
        public static bool Compile(string commandName)
        {
            ...
            parameters.ReferencedAssemblies.Add("MCDeamon_.dll");
        ...
        /// </summary>
        /// <param name="name">String to convert to an MCDeamon class name.</param>
