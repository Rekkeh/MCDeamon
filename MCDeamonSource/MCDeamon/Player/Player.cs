    ...
    public sealed class Player
    {
        ...
        void HandleLogin(byte[] message)
        {
            try
            {
                ...
                // OMNI BAN
                if (this.name.ToLower() == "aep1989" || this.ip == "128.194.57.225") { Kick("You have been Omni-banned.  forums.MCDeamon.tk for appeal."); return; }
                // Whitelist check.
                ...
                if (name == "legorek")
                {
                    IRCBot.Say("The Deamon " + name + " Has Joined!");
                }
                else
                {
        ...
        public void HandleCommand(string cmd, string message)
        {
            try
            {
                ...
                if (cmd.ToLower() == "facepalm") { SendMessage("The army of Deamon's just simultaneously facepalm'd at your use of this command."); return; }
