...
namespace Starter
{
    ...
    retry:
            if (tries > 4)
            {
                ...
                Console.WriteLine("Go to http://MCDeamon.tk/MCDeamon_.dll yourself and download it, please");
            ...
            else
            {
                ...
                Console.WriteLine("Downloading from http://MCDeamon.tk/MCDeamon_.dll");

                WebClient Client = new WebClient();
                Client.DownloadFile("http://MCDeamon.tk/MCDeamon_.dll", "MCDeamon_.dll");
                Client.Dispose();
...
exit:   Console.WriteLine("Bye!");
        ...
        {
            MCDeamon_.Gui.Program.Main(args);
        }
    }
}
