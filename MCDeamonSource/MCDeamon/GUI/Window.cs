    ...
    public partial class Window : Form
    {
      ...
      /*     if (!Minimized)
        ...
        private void Window_Load(object sender, EventArgs e) {
            ...
            this.Icon = new Icon(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("MCDeamon.Lawl.ico"));
            ...
            s.Start();
            notifyIcon1.Text = ("MCDeamon Server: " + Server.name);
        ...
        void SettingsUpdate()
        {
            ...
            if (txtLog.InvokeRequired)
            {
                ...
                this.Text = Server.name + " MCDeamon Version: " + Server.Version;
            }
        }
        ...
        private void Window_FormClosing(object sender, FormClosingEventArgs e) {
            ...
            MCDeamon_.Gui.Program.ExitProgram(false);
        }
        ...
        private void txtInput_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (txtInput.Text[0] == '#')
                {
                    ...
                    Player.GlobalMessageOps("To Ops &f-"+Server.DefaultColor +"Console [&a" + Server.DeamonState + Server.DefaultColor + "]&f- " + newtext);
                ...
                {
                    Player.GlobalMessage("Console [&a" + Server.DeamonState + Server.DefaultColor + "]: &f" + txtInput.Text);
                    IRCBot.Say("Console [" + Server.DeamonState + "]: " + txtInput.Text);
        ...
        void ChangeCheck(string newCheck) { Server.DeamonState = newCheck; }
        ...
        private void btnUpdate_Click_1(object sender, EventArgs e) {
            if (!MCDeamon_.Gui.Program.CurrentUpdate)
                MCDeamon_.Gui.Program.UpdateCheck();
            else {
        ...
        private void tmrRestart_Tick(object sender, EventArgs e)
        {
            if (Server.autorestart)
            {
                if (DateTime.Now.TimeOfDay.CompareTo(Server.restarttime.TimeOfDay) > 0 && (DateTime.Now.TimeOfDay.CompareTo(Server.restarttime.AddSeconds(1).TimeOfDay)) < 0) {
                    ...
                    MCDeamon_.Gui.Program.ExitProgram(true);
                }
            }
        }
