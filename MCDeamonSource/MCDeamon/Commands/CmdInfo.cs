...
namespace MCDeamon
{
    public class CmdInfo : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            {
                Player.SendMessage(p, "This server runs on &bMCDeamon" + Server.DefaultColor + ", which started as MCLawl, and was made much more feature-packed by Zallist, then picked up again and had development continued by Lawlcat, Valek and Zallist, And then forked and made better by Legorek");
